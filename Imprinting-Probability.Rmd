...
The final seasonal intensity, $I_t$, used in the calculations, was **normalized** by the mean intensity over the seasons from 1976 to 2017, i.e.
$$I_t = \frac{\tilde{I_t}}{\frac{1}{42}\sum_{t = 1976}^{2017} \tilde{I_t}}.$$
...
$$\text{ILI}_{1976} = \text{ILI}_{1977} = \ldots = \text{ILI}_{1996} = \frac{1}{21}\sum_{t=1997}^{2017} \text{ILI}_{t},$$
...
$$\tilde{I_t} = \frac{1}{42}\sum_{t = 1976}^{2017} \tilde{I_t}; \ t < 1976.$$
