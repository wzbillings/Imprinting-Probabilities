...
The final seasonal intensity, $I_t$, used in the calculations, was **normalized** by the mean intensity over the seasons from 1976 to 2020, i.e.
$$I_t = \frac{\tilde{I_t}}{\frac{1}{`r 2020 - 1976 + 1`}\sum_{k = 1976}^{2020} \tilde{I_k}}.$$
...
$$\text{ILI}_{t} = \frac{1}{`r 2020 - 1997 + 1`}\sum_{k=1997}^{2020} \text{ILI}_{k}; \ t = 1976, 1977, \ldots, 1996;$$
...
$$\tilde{I_t} = \frac{1}{`r 2020 - 1976 + 1`}\sum_{k = 1976}^{2020} \tilde{I_k}; \ t < 1976.$$
